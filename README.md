...
You have to design & build the backend for the application and the ability for the users to register, find available centres and book the slots.
...
https://github.com/azaylamba/vaccinationBooking 
